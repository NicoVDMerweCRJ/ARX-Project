...
%ADB% %DEVICE% install HelloARUnreal-armv7-es2.apk
...
%ADB% %DEVICE% shell pm grant com.google.ar.core.examples.unreal.helloar android.permission.READ_EXTERNAL_STORAGE
%ADB% %DEVICE% shell pm grant com.google.ar.core.examples.unreal.helloar android.permission.WRITE_EXTERNAL_STORAGE
@echo.
